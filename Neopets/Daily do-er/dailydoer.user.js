...
// @match http://www.neopets.com/wishing.phtml?thanks=21
...
if (bih.match('Wish Count: 7')) {
    ...
    break;
		...
		case 'http://www.neopets.com/wishing.phtml?thanks=21':
var bet = 21;
var item = 'Halloween Y14 Goodie Bag';
var bih = document.body.innerHTML;
...
$("input[value='Collect your gift']").click();
   ...
   $("input[value='Erm... OK I'll take one']").click();
   break;
...
var el=document.getElementById('form-fire-cannon');el.submit();el.parentNode.removeChild(el);return false; // this is the code the page uses
   break;
   /* 
   Grave danger code
   todo:
...
x = getRndInteger(200,800);$("input[name=guess]").val(x);
