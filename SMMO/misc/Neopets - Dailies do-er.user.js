...
// @namespace      httpss://github.com/oligochrome
...
// @match https://www.neopets.com/wishing.phtml?thanks=21&xt=
// @match https://www.neopets.com/games/lottery.phtml
// @match https://www.neopets.com/games/process_lottery.phtml
// @match https://www.neopets.com/medieval/turdlebetting.phtml
// @match https://www.neopets.com/medieval/turmaculus.phtml
// @match https://www.neopets.com/altador/council.phtml
// @match https://www.neopets.com/altador/council.phtml?prhv=a60ef8d87426ebb141660602ac9a77dd
// @match https://www.neopets.com/halloween/scratch.phtml
// @match https://www.neopets.com/halloween/scratch2.phtml
// @match https://www.neopets.com/water/fishing.phtml
// @match https://www.neopets.com/jelly/jelly.phtml
// @match https://www.neopets.com/worlds/geraptiku/tomb.phtml
// @match https://www.neopets.com/prehistoric/omelette.phtml
// @match https://www.neopets.com/halloween/applebobbing.phtml
// @match https://www.neopets.com/pirates/anchormanagement.phtml
// @match https://www.neopets.com/halloween/gravedanger/index.phtml
// @match https://www.neopets.com/winter/adventcalendar.phtml
// @match https://www.neopets.com/island/tombola.phtml
...
// @match https://www.neopets.com/faerieland/tdmbgpop.phtml
// @match https://www.neopets.com/moon/meteor.phtml
// @match https://www.neopets.com/moon/meteor.phtml?getclose=1
// @match https://www.neopets.com/pirates/buriedtreasure/index.phtml
// @match https://www.neopets.com/pirates/buriedtreasure/buriedtreasure.phtml?
...
// @match https://www.neopets.com/faerieland/caverns/index.phtml
...
switch (expr) {
    case 'https://www.neopets.com/faerieland/springs.phtml':
        $("input[value='Heal my Pets']").click();
        break;
    case 'https://www.neopets.com/water/fishing.phtml':
        document.querySelector("input[value='Reel In Your Line']").click();
        break;

    case 'https://www.neopets.com/jelly/jelly.phtml':
        $("input[value='Grab some Jelly']").click();
        break;

    case 'https://www.neopets.com/worlds/geraptiku/tomb.phtml':
        window.location.assign("https://www.neopets.com/worlds/geraptiku/process_tomb.phtml")
        break;

    case 'https://www.neopets.com/prehistoric/omelette.phtml':
        $("input[value='Grab some Omelette']").click();
        break;

    case 'https://www.neopets.com/halloween/applebobbing.phtml?':
        case 'https://www.neopets.com/halloween/applebobbing.phtml':
        window.location.assign("https://www.neopets.com/halloween/applebobbing.phtml?bobbing=1")
        break;

		    case 'https://www.neopets.com/desert/fruit/index.phtml':
        $("input[value='Spin, spin, spin!']").click();
        break;

    case 'https://www.neopets.com/desert/shrine.phtml':
        $("input[value='Approach the Shrine']").click();
        break;

    case 'https://www.neopets.com/faerieland/tdmbgpop.phtml':
        $("input[value='Talk to the Plushie']").click();
        break;

    case 'https://www.neopets.com/moon/meteor.phtml':
        $("input[value='Take a chance']").click();
        break;

    case 'https://www.neopets.com/moon/meteor.phtml?getclose=1':
        $("input[value='Submit']").click();
        break;

    case 'https://www.neopets.com/pirates/buriedtreasure/index.phtml':
        $("input[value='Click to Play!  Only 300 NP a game!']").click();
        break;


    case 'https://www.neopets.com/wishing.phtml':

    case 'https://www.neopets.com/wishing.phtml?thanks=21&xt=':
        var bet = 21;
    ...
    case 'https://www.neopets.com/games/lottery.phtml':
    ...
    case 'https://www.neopets.com/games/process_lottery.phtml':
        if (document.body.innerHTML.match('check back tomorrow')) {
            document.links[0].href = 'https://www.neopets.com/games/lottery.phtml';
        }
        return;
        break;

    case 'https://www.neopets.com/medieval/turdlebetting.phtml':
    ...
    case 'https://www.neopets.com/medieval/turmaculus.phtml':
    ...
    case 'https://www.neopets.com/altador/council.phtml':
        window.location.assign("https://www.neopets.com/altador/council.phtml?prhv=a60ef8d87426ebb141660602ac9a77dd")
        break;

    case 'https://www.neopets.com/altador/council.phtml?prhv=a60ef8d87426ebb141660602ac9a77dd':
        $("input[value='Collect your gift']").click();
        break;

    case 'https://www.neopets.com/halloween/scratch.phtml':
    ...
    case 'https://www.neopets.com/halloween/scratch2.phtml':
    ...
    case 'https://www.neopets.com/pirates/anchormanagement.phtml':
...
*/
    case 'https://www.neopets.com/halloween/gravedanger/index.phtml':
        $("input[value='Adventure again!']").click();
        break;
    case 'https://www.neopets.com/winter/adventcalendar.phtml':
        $("input[value='Collect My Prize!!!']").click();
        break;
    case 'https://www.neopets.com/island/tombola.phtml':
        $("input[value='Play Tombola!']").click();
        break;
    case 'https://www.neopets.com/medieval/guessmarrow.phtml':
        ...
        break;
    case 'https://www.neopets.com/medieval/wiseking.phtml':
  ...
  case 'https://www.neopets.com/medieval/grumpyking.phtml' :
  for (var x = 0, thisForm; thisForm = document.forms[x]; x++){
...
//      selections = new Array('What', 'do', 'you do if', '', 'fierce', 'Peophins', '', 'has eaten too much', '', 'tin of olives', 'You', 'offering', 'a', 'tin of', '', 'what what what', '', '')
 ...
 break;
    ...
    case ('https://www.neopets.com/pirates/buriedtreasure/buriedtreasure.phtml?'):
        window.location.assign("https://www.neopets.com/pirates/buriedtreasure/buriedtreasure.phtml?" + (Math.round(Math.random() * 449) + 26) + "," + (Math.round(Math.random() * 454) + 31))
        break;

    case ('https://www.neopets.com/medieval/symolhole.phtml'):
    ...
    case 'https://www.neopets.com/bank.phtml' : // ooops added brackets, removed now
...
document.body.innerHTML += '<form id="bank" action="https://www.neopets.com/process_bank.phtml" method="post"><input type="hidden" name="type" value="interest"></form>';
...
break;
    ...
    //
  case ('https://www.neopets.com/market.phtml?type=till') :
...
$('[name="amount"]').val(np);
  ...
  case 'https://www.neopets.com/medieval/potatocounter.phtml' :
...
break;
  ...
  // end potato counter
    ...
    // // // // Cheeseroller
  case 'https://www.neopets.com/medieval/cheeseroller.phtml' :
...
<option value="Shiny Golden Cheese">Shiny Golden Cheese - 4350np</option>\
  ...
  function changeImg(item){
    thisImg.src = 'https://images.neopets.com/items/'+item+'.gif';
  }
  ...
  case 'https://www.neopets.com/shenkuu/lunar/?show=puzzle' :
...
newElement.innerHTML='<div style="padding:2px; font-weight:bold; font-size:11pt; text-align:center; background-color:white; color:black;"> The correct lunar phase is:<br><br><img src="https://images.neopets.com/shenkuu/lunar/phases/'+ moon +'.gif" border="0" width="60" height="60"><br><br><font class="sf" color="#3a84b0">(Click the already selected circle to submit your answer.)</font></div><br>';
...
case 'https://www.neopets.com/faerieland/caverns/index.phtml' :
